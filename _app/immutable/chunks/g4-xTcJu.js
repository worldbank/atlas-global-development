import{b as cn,a as un}from"./kLL9CGjB.js";import{p as Bt,l as Xe,m as ke,n as ie,f as zt,q as Lt,v as Ge,g as p,x as me,y as Oe,z as Ve,B as Ke,i as fe,A as bt,u as En,L as Os,M as Bs,C as dn,J as Ct,G as Dt,a8 as ea}from"./B-c_3SZA.js";import{s as Ut,b as D,e as yt,n as xt,f as Qe,x as Vi,y as Wi}from"./amWkAaQy.js";import{p as Vt,i as lt,b as zs}from"./kZfKHkdY.js";import{C as yn}from"./EJQ-7jAx.js";import{C as xe,f as ks,d as di,c as v1}from"./fLcxze8F.js";import{g as xn}from"./DhR9_8hC.js";import{l as y1}from"./Co2p4suz.js";import{c as $i}from"./UAFRlFgY.js";import{a as Qo}from"./DROhtFDv.js";import{s as Hs,a as Gs}from"./D7YRea9s.js";import{i as Vs}from"./CEYz6AUG.js";import{T as In}from"./wRh0VKaH.js";import{c as Nn}from"./Dv3aAGed.js";import{e as x1}from"./Ez7xxADz.js";import{c as W1}from"./CE6Kp46i.js";import{d as X1}from"./BNtUbFRg.js";import{f as q1}from"./DzWSY_RA.js";import{k as Dn,l as mr,e as Y1,p as Ws,d as Xs,s as j1,b as qs,g as Zi,m as qr}from"./D2_TtDp4.js";import{b as Ys}from"./BAzbs-zr.js";import{r as Pi}from"./OtVwhkKS.js";import{S as js}from"./dw3aNbov.js";import{s as Ks}from"./CFoKPjf3.js";import{L as or}from"./CH_tcJ5e.js";import{p as M1,d as Zs,e as Js}from"./Dh8T2X1i.js";import{s as sr}from"./BrPRFtCX.js";import{b as $o}from"./BFAGQsmD.js";import{C as Qs}from"./DGeRfYgQ.js";function K1(i,e,t){var n=Pi(i,e-Dn,t).concat(e);return function(r){return n.map(function(a){return[r,a]})}}function Z1(i,e,t){var n=Pi(i,e-Dn,t).concat(e);return function(r){return n.map(function(a){return[a,r]})}}function $s(){var i,e,t,n,r,a,o,s,l=10,c=l,f=90,u=360,h,m,y,_,g=2.5;function d(){return{type:"MultiLineString",coordinates:x()}}function x(){return Pi(mr(n/f)*f,t,f).map(y).concat(Pi(mr(s/u)*u,o,u).map(_)).concat(Pi(mr(e/l)*l,i,l).filter(function(v){return Y1(v%f)>Dn}).map(h)).concat(Pi(mr(a/c)*c,r,c).filter(function(v){return Y1(v%u)>Dn}).map(m))}return d.lines=function(){return x().map(function(v){return{type:"LineString",coordinates:v}})},d.outline=function(){return{type:"Polygon",coordinates:[y(n).concat(_(o).slice(1),y(t).reverse().slice(1),_(s).reverse().slice(1))]}},d.extent=function(v){return arguments.length?d.extentMajor(v).extentMinor(v):d.extentMinor()},d.extentMajor=function(v){return arguments.length?(n=+v[0][0],t=+v[1][0],s=+v[0][1],o=+v[1][1],n>t&&(v=n,n=t,t=v),s>o&&(v=s,s=o,o=v),d.precision(g)):[[n,s],[t,o]]},d.extentMinor=function(v){return arguments.length?(e=+v[0][0],i=+v[1][0],a=+v[0][1],r=+v[1][1],e>i&&(v=e,e=i,i=v),a>r&&(v=a,a=r,r=v),d.precision(g)):[[e,a],[i,r]]},d.step=function(v){return arguments.length?d.stepMajor(v).stepMinor(v):d.stepMinor()},d.stepMajor=function(v){return arguments.length?(f=+v[0],u=+v[1],d):[f,u]},d.stepMinor=function(v){return arguments.length?(l=+v[0],c=+v[1],d):[l,c]},d.precision=function(v){return arguments.length?(g=+v,h=K1(a,r,90),m=Z1(e,i,g),y=K1(s,o,90),_=Z1(n,t,g),d):g},d.extentMajor([[-180,-90+Dn],[180,90-Dn]]).extentMinor([[-180,-80-Dn],[180,80+Dn]])}function es(i,e){return[Xs(e)*j1(i),j1(e)]}es.invert=Ys(qs);function Br(){return Ws(es).scale(249.5).clipAngle(90+Dn)}/**
 * @license
